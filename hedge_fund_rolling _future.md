Rolling future case is a wildly used case in hedge fund analysis practise. This case has three stages, and the demand is gradually increasing. This chapter will introduce these three phases one by one.
