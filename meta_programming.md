...
- [`binaryExpr`](https://www.dolphindb.cn/cn/help/FunctionsandCommands/FunctionReferences/b/binaryExpr.html)生成一个二元运算的元代码。例如：
...
* [`unifiedExpr`](https://www.dolphindb.cn/cn/help/FunctionsandCommands/FunctionReferences/u/unifiedExpr.html)生成一个多元运算表达式的元代码。例如：
...
- [`makeCall`](https://www.dolphindb.cn/cn/help/FunctionsandCommands/FunctionReferences/m/makeCall.html)函数和[`makeUnifiedCall`](https://www.dolphindb.cn/cn/help/FunctionsandCommands/FunctionReferences/m/makeUnifiedCall.html)根据指定的函数与参数生成元代码。
